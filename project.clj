(defproject bazaar-droid/bazaar-droid "0.0.1-SNAPSHOT"
             ...
             [:android-common ;;:android-user
              {:dependencies [[org.clojure-android/tools.nrepl "0.2.6"]]
               ...
               :android {:aot :all-with-unused
                         :rename-manifest-package "bazaar.droid.debug"
                         :manifest-options {:app-name "bazaar-droid - debug"}}}]
             :release
             [:android-common
  ...
  :android {;; Specify the path to the Android SDK directory.
            ;;:sdk-path "/home/mhjort/Android/Sdk"
